...
<div class="container">
	...
	<?php 
 		if (isset($_POST['submit_1'])) {
 			...
 			if (empty($name) || empty($last_name) || empty($email) || empty($cell) || empty($uname)) {
 				...
 				$student -> updateStudentInfo($name, $last_name, $email, $cell, $uname, $id);
 			}
 		}
	...
	<div class="card">
		<div class="modal-header"> <h3 class="text-primary">Update Student</h3></div>
        ...
        <div class="card-body col-form-label-sm">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input name="submit_1" class="btn-primary" type="submit" value="Update Student">
                </div>            
            </form>
   		</div>
	</div>
